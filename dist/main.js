...
/*!********************!*\
  !*** ./src/app.js ***!
  \********************/
var movieData; // document.addEventListener('DOMContentLoaded', function (e) {
...
var createVision = function createVision(movieData, idx) {
  ...
  var svg = d3.select('#vision').append('svg').attr('class', "".concat(targetSVG, " hidden")).attr('viewBox', "0 21 650 100").attr('preserveAspectRatio', 'xMinYMin meet');
